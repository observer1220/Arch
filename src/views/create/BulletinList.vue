  ...
  <div class="newsList_container">
    <el-form :inline="true">
      <el-form-item style="margin:0">
        <h2 class="tableTitle">【公告列表】<span>共有{{ setData.length }}篇公告</span></h2>
      </el-form-item>
    ...
    <el-table :data='setData' border :default-sort = "{prop: 'create_time', order: 'ascending'}" stripe>
      ...
      <CreateTime/>
      <el-table-column prop="title" label="公告標題" align='left' width="550"></el-table-column>
    ...
    <BulletinDialog :dialogUser='dialogUser' :caseForm="caseForm"/>
  </div>
</template>
<script>
import { db } from '../../firebase'
import Swal from 'sweetalert2'
import BulletinDialog from '../../dialog/BulletinDialog'
